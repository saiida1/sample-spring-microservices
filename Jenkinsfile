...
node {
    stage('deploy staging') {
                    ...
                    sh 'cd docker && rancher-compose --url http://192.168.56.101:8080/v1/projects/1a5 --access-key 126F12D08951CE0554F2 --secret-key Ps1tpHbUmJ93LZ2avGQgrXGUJLgqqn86CMd3V56h up -d'
         //       }
