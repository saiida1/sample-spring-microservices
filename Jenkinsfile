...
def notifySlack(String buildStatus = 'STARTED') {
            ...
            slackSend(color: color, message: msg, image_url: "https://www.google.com/search?q=jenkins&client=ubuntu&hs=wu7&channel=fs&source=lnms&tbm=isch&sa=X&ved=0ahUKEwjt2sDzkufZAhUBchQKHUE1AfYQ_AUICigB&biw=1615&bih=952#imgrc=RfAGljvc9m-P1M:")
}
 try {      
         stage('Test') {
