...
try {
                       ...
                       sh 'cd stack-master && cd docker && rancher-compose --url http://192.168.56.101:8080/v1/projects/1a5 --access-key B9D9EDC9AF35290AF178 --secret-key DRYbZZ96uM4mNTWWMooqrQVPXDcLm95sEGjMqBNd rm'
                    } catch (any) {}
                    ...
                    try {
                        // remove the old rancher stack in case it exists, if not ignore all errors
                       sh 'cd stack-trunk && cd docker && rancher-compose --url http://192.168.56.101:8080/v1/projects/1a5 --access-key B9D9EDC9AF35290AF178 --secret-key DRYbZZ96uM4mNTWWMooqrQVPXDcLm95sEGjMqBNd rm'
                    } catch (any) {}
